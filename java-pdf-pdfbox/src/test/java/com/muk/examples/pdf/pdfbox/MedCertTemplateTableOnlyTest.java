...
import static com.muk.examples.pdf.pdfbox.MedCertTemplateTableOnly.*;
...
public class MedCertTemplateTableOnlyTest {
  ...
  public void generateMedicaidCertificate() throws IOException {
    ...
    MedCertTemplateTableOnly rptTemplate = new MedCertTemplateTableOnly(parameters);
    
    rptTemplate.save("target/Med_Cert_TableOnly.pdf");
